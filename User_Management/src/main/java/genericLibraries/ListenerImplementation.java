...
public void onStart(ITestContext context) {
	ExtentSparkReporter spark=new ExtentSparkReporter("./ExtendReports/extendReport.html");
	spark.config().setDocumentTitle("Title- E 360");
	spark.config().setReportName("User Data Reports");
	spark.config().setTheme(Theme.DARK);
	report= new ExtentReports();
	report.attachReporter(spark);
	report.setSystemInfo("Author", "Vinny");
	report.setSystemInfo("OS", "Windwows");
